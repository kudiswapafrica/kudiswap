...
mod KudiAccount {
    ...
    impl AccountImpl of super::IAccount<ContractState> {
        ...
        fn execute_meta_transaction(
            ...
            // Validate signature
            let mut _call_data: Array<felt252> = ArrayTrait::new();
            let mut calls_span = calls.span();
            ...
            for call in calls_span.pop_front() {
                let call = *call;
                let result = self.execute_single_call(call);
                results.append(result);
            } 
    ...
    impl GuardianRecoveryImpl of IGuardianRecovery {
        ...
        fn recover_account(
            ...
            let _recovery_hash = self._compute_recovery_hash(new_public_key);
    ...
    impl InternalFunctions of InternalFunctionsTrait {
        ...
        fn execute_single_call(
            ...
            match res {
                ...
                Result::Err(_revert_reason) => {
                    // Instead of panicking, return an empty Span to indicate failure
                    array![].span()
                }
            }
        }
        ...
        fn validate_transaction(ref self: ContractState) -> bool {
            ...
            if version == TRANSACTION_VERSION {
                ...
                let given_nonce = tx_info.nonce.try_into().unwrap(); // felt252 → u128
                let current_nonce = self.nonce.read();
